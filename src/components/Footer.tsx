    ...
    <footer className="relative overflow-hidden">
      ...
      <div className="relative z-20 backdrop-blur-sm bg-black/40 border-t border-purple-500/30">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="space-y-4 animate-float text-center md:text-left">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Creating digital universes where imagination meets reality in
            ...
            {/* Connect Section */}
            <div
              className="animate-float text-center md:text-right"
          ...
          {/* Copyright */}
          <div
            className="text-center pt-4 border-t border-purple-500/20 animate-float"
            style={{ animationDelay: "1s" }}
          >
            <p className="text-gray-400 text-sm">
              © {currentYear} RenzMc - Exploring the infinite cosmos of
              creativity
            </p>
          </div>
        </div>
      ...
      <div
        className="absolute bottom-12 left-12 w-24 h-24 bg-gradient-to-r from-cyan-600/10 to-purple-600/10 rounded-full blur-2xl animate-nebula-flow"
